package com.apps.abcd.integrationtest;
...
import com.apps.abcd.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("_a_b_c_d_a_p_p_", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Buses?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Buses/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Trips?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Trips/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Drivers?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Drivers/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Routes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/_a_b_c_d_a_p_p_/Routes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM abcdv1.Bus");
    jdbcTemplate.execute("DELETE FROM abcdv1.Trip");
    jdbcTemplate.execute("DELETE FROM abcdv1.Driver");
    jdbcTemplate.execute("DELETE FROM abcdv1.Route");
     jdbcTemplate.execute("DELETE FROM abcdv1.BusDrivers");
     jdbcTemplate.execute("DELETE FROM abcdv1.BusTrips");
